...
// Adapters
include_once("geoPHP/lib/adapters/GeoAdapter.class.php"); // Abtract class
include_once("geoPHP/lib/adapters/GeoJSON.class.php");
include_once("geoPHP/lib/adapters/WKT.class.php");
include_once("geoPHP/lib/adapters/WKB.class.php");
include_once("geoPHP/lib/adapters/KML.class.php");
include_once("geoPHP/lib/adapters/GPX.class.php");
include_once("geoPHP/lib/adapters/GeoRSS.class.php");
include_once("geoPHP/lib/adapters/GoogleGeocode.class.php");

// Geometries
include_once("geoPHP/lib/geometry/Geometry.class.php"); // Abtract class
include_once("geoPHP/lib/geometry/Point.class.php");
include_once("geoPHP/lib/geometry/Collection.class.php"); // Abtract class
include_once("geoPHP/lib/geometry/LineString.class.php");
include_once("geoPHP/lib/geometry/MultiPoint.class.php");
include_once("geoPHP/lib/geometry/Polygon.class.php");
include_once("geoPHP/lib/geometry/MultiLineString.class.php");
include_once("geoPHP/lib/geometry/MultiPolygon.class.php");
include_once("geoPHP/lib/geometry/GeometryCollection.class.php");

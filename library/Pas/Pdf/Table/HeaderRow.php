<?php
class Pas_Pdf_Table_HeaderRow extends Pas_Pdf_Table_Row {
	...
	public function __construct($labels=array()){
		...
		$this->_align=Pas_Pdf::CENTER;

		//set default borders
		$style=new Zend_Pdf_Style();
		$style->setLineWidth(2);
		$this->setBorder(Pas_Pdf::BOTTOM,$style);
	...
	public function preRender(Pas_Pdf_Page $page,$posX,$posY){

...
class Pas_Pdf_Table_Row {
	 ...
	 * Get Row Columns
	 *
	 * @return array(Pas_Pdf_Table_Column)
	 */
	 ...
	 * Set Row Columns
	 *
	 * @param array(Pas_Pdf_Table_Column,...) $columns
	 */
	 ...
	 *
	 * @param Pas_Pdf_Table_Column $col
	 * @param int index of new Coumn $index
	 */
	public function insertColumn(Pas_Pdf_Table_Column $col,$index){
	...
	public function preRender(Pas_Pdf_Page $page,$posX,$posY,$inContentArea=true) {
		...
		if($this->_width){
			...
			if($inContentArea){
				$max_row_width=$page->getWidth()-$page->getMargin(Pas_Pdf::LEFT)-$page->getMargin(Pas_Pdf::RIGHT);
			}
			else{
